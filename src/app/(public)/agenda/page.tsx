        ...
        <div className="flex flex-col gap-32 pb-32 bg-white">
            ...
            <section className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    {events.map((event) => (
                        <div key={event.id} className="group flex flex-col md:flex-row bg-white rounded-[4.5rem] overflow-hidden border border-slate-100 shadow-xl hover:shadow-[0_40px_100px_rgba(0,0,0,0.08)] transition-all duration-700 hover:-translate-y-3">
                            <div className="w-full md:w-72 h-72 md:h-auto relative bg-slate-50 overflow-hidden">
                                {event.image ? (
                                    <Image
                                ...
                                <div className="absolute top-8 left-8 md:hidden">
                                    <div className="bg-white/95 backdrop-blur-md text-slate-900 px-6 py-3 rounded-2xl font-black text-xl shadow-xl border border-white/50">
                            ...
                            <div className="p-12 flex-1 flex flex-col justify-center">
                                <div className="flex items-center gap-6 mb-10">
                                    <div className="hidden md:flex flex-col items-center justify-center w-24 h-24 rounded-[2rem] bg-white border border-slate-100 shadow-xl text-slate-900">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="text-3xl font-black mb-4 group-hover:text-primary transition-colors leading-tight text-slate-900 line-clamp-2">{event.title}</h3>
                                ...
                                <p className="text-slate-500 font-medium text-lg line-clamp-3 leading-relaxed mb-10">
                                    {event.description}
                                </p>
                ...
                {events.length === 0 && (
                    <div className="text-center py-48 bg-slate-50 rounded-[5rem] border-2 border-dashed border-slate-200">
                        ...
                        <h3 className="text-4xl font-black text-slate-900 mb-6 tracking-tighter">No Events Scheduled</h3>
                        <p className="text-slate-500 text-xl font-medium">We'll be updating our calendar soon. Please check back later.</p>
                    </div>
                )}
            </section>
        </div>
