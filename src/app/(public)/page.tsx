...
export default async function HomePage() {
    ...
    return (
        <div className="flex flex-col bg-white dark:bg-slate-950">
            {/* Hero Section */}
            <section className="relative min-h-[calc(100vh-72px)] flex items-center py-20 lg:py-0 overflow-visible bg-slate-50 dark:bg-slate-900/30">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="animate-slide-up">
                            <div className="inline-flex items-center space-x-3 bg-slate-900/[0.03] border border-slate-900/10 px-5 py-2 rounded-full mb-8">
                                ...
                                <span className="text-slate-500 dark:text-slate-400 text-[11px] font-black uppercase tracking-[0.3em]">{t("hero.badge")}</span>
                            </div>
                            
                            <h1 className="text-4xl md:text-7xl lg:text-8xl font-black mb-8 leading-[0.9] tracking-tighter text-slate-900 dark:text-white">
                            ...
                            <p className="text-lg md:text-xl mb-10 text-slate-600 dark:text-slate-400 leading-relaxed font-medium max-w-xl">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-10 sm:gap-12">
                                <Button size="lg" className="bg-slate-900 text-white hover:bg-primary hover:text-slate-900 dark:text-white h-20 px-12 rounded-[2rem] text-xl font-black shadow-2xl shadow-primary/20 transition-all group w-full sm:w-auto" asChild>
                                ...
                                <div className="flex items-center gap-6 bg-white dark:bg-slate-950/50 backdrop-blur-sm p-4 pr-8 rounded-[2.5rem] border border-white/50 shadow-sm group hover:bg-white dark:bg-slate-950 hover:shadow-xl transition-all duration-500">
                        ...
                        <div className="relative animate-fade-in delay-300 hidden lg:block">
                            <div className="relative aspect-square rounded-[3rem] overflow-hidden bg-slate-100 dark:bg-slate-800 border-[12px] border-slate-50 shadow-[inset_0_10px_40px_rgba(0,0,0,0.1)]">
                                <HeroSlider 
                                    images={
                            ...
                            {/* Simplified Badge */}
                            <div className="absolute -bottom-6 -right-6 bg-white dark:bg-slate-950 p-6 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 flex items-center gap-4">
                                <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center">
                                    <Star className="h-6 w-6 text-slate-900 dark:text-white fill-current" />
                                </div>
                                <div>
                                    <div className="text-xl font-black text-slate-900 dark:text-white">4.9/5</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.length > 0 ? (
                        features.map((feature, i) => {
                            ...
                            return (
                                <div key={feature.id} 
                                     className="group bg-white dark:bg-slate-950 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 relative overflow-hidden"
                                >
                                    <div className="relative z-10">
                                        <div className="w-16 h-16 bg-slate-50 dark:bg-slate-900 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-primary transition-all duration-500 border border-white">
                                            <IconComponent className="h-8 w-8 text-primary group-hover:text-slate-900 dark:text-white transition-colors" />
                                        </div>
                                        <h3 className="text-2xl font-black mb-4 text-slate-900 dark:text-white group-hover:text-primary transition-colors tracking-tight">
                                            {feature.title}
                                        </h3>
                                        <p className="text-slate-500 dark:text-slate-400 text-base font-medium leading-relaxed mb-8">
                                            {feature.description}
                                        </p>
                                        <div className="h-1.5 w-12 bg-slate-100 dark:bg-slate-800 rounded-full group-hover:bg-primary transition-all duration-500 group-hover:w-full" />
                                    </div>
                                </div>
                            );
                        })
                        ...
                        [
                            ...
                            <div key={i} className="group bg-white dark:bg-slate-950 p-14 rounded-[4.5rem] border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-[0_60px_120px_rgba(0,0,0,0.1)] hover:-translate-y-6 transition-all duration-700">
                                <div className="w-24 h-24 bg-slate-50 dark:bg-slate-900 rounded-3xl flex items-center justify-center mb-12 group-hover:bg-primary transition-all duration-500 shadow-xl border border-white">
                                    <item.icon className="h-12 w-12 text-primary group-hover:text-slate-900 dark:text-white transition-colors" />
                                </div>
                                <h3 className="text-4xl font-black mb-8 text-slate-900 dark:text-white group-hover:text-primary transition-colors tracking-tight">{item.title}</h3>
                                <p className="text-slate-500 dark:text-slate-400 text-xl font-medium leading-relaxed mb-12">{item.desc}</p>
                                <div className="h-2 w-20 bg-slate-100 dark:bg-slate-800 rounded-full group-hover:bg-primary transition-all duration-500 group-hover:w-full" />
                            </div>
                        ))
                    )}
                </div>
                ...
                <section className="bg-slate-900 py-32 text-white overflow-hidden">
                    <div className="container mx-auto px-6">
                        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                            ...
                            <Button variant="outline" className="border-slate-700 text-slate-300 hover:bg-white dark:bg-slate-950 hover:text-slate-900 dark:text-white rounded-full px-8" asChild>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {teachersList.map((teacher) => (
                                <div key={teacher.id} className="group text-center">
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400 text-sm line-clamp-3 px-4">{teacher.bio}</p>
                                </div>
                            ))}
                        </div>
                        <div className="text-center mt-16">
                            <Button size="lg" className="bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white hover:bg-primary hover:text-slate-900 dark:text-white rounded-full px-12 font-bold shadow-sm" asChild>
            ...
            {/* News Section */}
            <section className="bg-slate-50 dark:bg-slate-900 py-40">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between mb-24 gap-8">
                        ...
                        <Link href="/news" className="group flex items-center gap-6 text-slate-900 dark:text-white font-black uppercase tracking-[0.4em] text-xs">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                        {latestPosts.map((post) => (
                            <Link key={post.id} href={`/news/${post.slug}`} className="group h-full">
                                <article className="flex flex-col h-full bg-white dark:bg-slate-950 rounded-[4rem] overflow-hidden border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-[0_40px_100px_rgba(0,0,0,0.08)] hover:-translate-y-4 transition-all duration-700">
                                    <div className="relative h-80 overflow-hidden">
                                        ...
                                        <div className="absolute top-8 left-8">
                                            <span className="bg-white dark:bg-slate-950/95 backdrop-blur-md px-6 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white shadow-xl">
                                                {post.category}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="p-12 flex flex-col flex-1">
                                        ...
                                        <h3 className="text-3xl font-black mb-6 text-slate-900 dark:text-white group-hover:text-primary transition-colors line-clamp-2 leading-tight">
                                            {post.title}
                                        </h3>
                                        <p className="text-slate-500 dark:text-slate-400 text-lg font-medium leading-relaxed mb-10 line-clamp-3 flex-1">
                                            {post.content}
                                        </p>
                                        <div className="flex items-center gap-4 text-slate-900 dark:text-white font-black text-xs uppercase tracking-[0.3em] group-hover:text-primary transition-all">
            ...
            <section className="container mx-auto px-4">
                <div className="bg-white dark:bg-slate-950 rounded-[5rem] border border-slate-100 dark:border-slate-800 p-12 md:p-32 shadow-[0_40px_120px_rgba(0,0,0,0.05)]">
                    <div className="text-center mb-24">
                        ...
                        <h2 className="text-5xl md:text-8xl font-black mb-8 tracking-tighter text-slate-900 dark:text-white">{t("events.headline")}</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-2xl max-w-3xl mx-auto font-medium leading-relaxed">{t("events.subheadline")}</p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        {upcomingEvents.map((event) => (
                            <Link key={event.id} href="/agenda" className="group">
                                <div className="flex flex-col md:flex-row bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[4rem] overflow-hidden hover:bg-white dark:bg-slate-950 hover:shadow-2xl hover:border-primary/20 transition-all duration-700 hover:-translate-y-3">
                                    <div className="w-full md:w-56 bg-primary text-slate-900 dark:text-white flex flex-col items-center justify-center p-12 relative shadow-xl">
                                    ...
                                    <div className="p-12 flex-1 flex flex-col justify-center">
                                        <h3 className="text-3xl font-black mb-6 text-slate-900 dark:text-white group-hover:text-primary transition-colors line-clamp-1 leading-tight">{event.title}</h3>
                                        ...
                                        <p className="text-slate-500 dark:text-slate-400 text-lg line-clamp-2 leading-relaxed font-medium">
                                            {event.description}
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="container mx-auto px-6">
                <div className="relative rounded-[3rem] overflow-hidden bg-primary p-16 md:p-24 text-center shadow-2xl">
                    <div className="relative z-10 max-w-4xl mx-auto">
                        <div className="w-16 h-16 bg-white dark:bg-slate-950 text-slate-900 dark:text-white rounded-2xl flex items-center justify-center mx-auto mb-10 rotate-6 shadow-lg border border-white/50">
                            <Star className="h-8 w-8 fill-current text-primary" />
                        </div>
                        <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter text-slate-900 dark:text-white leading-[0.9]">
                            {t("cta.headline")}
                        </h2>
                        <p className="text-lg md:text-xl mb-12 text-slate-800 dark:text-slate-200 font-medium leading-relaxed max-w-2xl mx-auto">
                            {t("cta.subheadline")}
                        </p>
                        <div className="flex flex-wrap justify-center gap-6">
                            <Button size="lg" className="bg-slate-900 text-white hover:bg-white dark:bg-slate-950 hover:text-slate-900 dark:text-white h-16 px-12 rounded-2xl text-xl font-bold shadow-xl transition-all hover:scale-105 active:scale-95" asChild>
                                <Link href="/contact">{t("cta.applyNow")}</Link>
                            </Button>
                            <Button size="lg" variant="outline" className="h-16 px-12 rounded-2xl text-xl font-bold bg-white dark:bg-slate-950/20 border-white/40 text-slate-900 dark:text-white backdrop-blur-md hover:bg-white dark:bg-slate-950 transition-all hover:scale-105 active:scale-95" asChild>
