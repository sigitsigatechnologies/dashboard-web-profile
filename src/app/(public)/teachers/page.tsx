            ...
            <section className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    {teachers.map((teacher) => (
                        <div key={teacher.id} className="group text-center bg-white p-8 rounded-[3rem] shadow-xl hover:shadow-2xl transition-all duration-500 border border-slate-100 hover:-translate-y-2 flex flex-col items-center">
                            ...
                            <p className="text-slate-500 text-base leading-relaxed">{teacher.bio}</p>
                        </div>
                    ))}
                </div>
            </section>
