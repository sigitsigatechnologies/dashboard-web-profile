        ...
        <div className="flex flex-col gap-32 pb-32 bg-white dark:bg-slate-950">
            ...
            <section className="container mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div className="relative aspect-[4/3] rounded-[4.5rem] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.08)] group border border-slate-100 dark:border-slate-800">
                        <Image
                    ...
                    <div>
                        <div className="mb-8 inline-flex items-center rounded-full px-8 py-3 text-xs font-black uppercase tracking-[0.3em] bg-primary/10 text-slate-900 dark:text-white border border-primary/20">
                            {t("profile.journeyBadge")}
                        </div>
                        <h2 className="text-5xl md:text-[6rem] font-black mb-10 leading-[0.9] tracking-tighter text-slate-900 dark:text-white">{t("profile.journeyHeadline")}</h2>
            ...
            {/* Vision & Mission */}
            <section className="bg-slate-50 dark:bg-slate-900 py-40 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        <div className="p-16 bg-white dark:bg-slate-950 rounded-[4.5rem] border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-3xl transition-all duration-700">
                            <div className="w-24 h-24 bg-primary text-slate-900 dark:text-white rounded-[2rem] flex items-center justify-center mb-12 shadow-2xl rotate-3">
                                <LucideIcons.Target className="h-12 w-12" />
                            </div>
                            <h2 className="text-4xl font-black mb-8 text-slate-900 dark:text-white">{t("profile.visionTitle")}</h2>
                            <p className="text-2xl text-slate-500 dark:text-slate-400 leading-relaxed font-medium italic opacity-90">
                                "{profile?.vision || "To be a world-class institution that nurtures future leaders with integrity and innovation."}"
                            </p>
                        </div>
                        <div className="p-16 bg-white dark:bg-slate-950 rounded-[4.5rem] border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-3xl transition-all duration-700">
                            <div className="w-24 h-24 bg-slate-50 dark:bg-slate-900 rounded-[2rem] flex items-center justify-center mb-12 border border-slate-100 dark:border-slate-800 -rotate-3">
                                <LucideIcons.Rocket className="h-12 w-12 text-primary" />
                            </div>
                            <h2 className="text-4xl font-black mb-8 text-slate-900 dark:text-white">{t("profile.missionTitle")}</h2>
                            <ul className="space-y-8">
                                {profile?.mission ? (
                                    profile.mission.split('\n').map((m: string, i: number) => (
                                        <li key={i} className="flex items-start gap-6 group">
                                            <div className="mt-1.5 p-1 rounded-full bg-primary/20 border border-primary/40 group-hover:bg-primary transition-colors">
                                                <LucideIcons.Check className="h-4 w-4 text-slate-900 dark:text-white" />
                                            </div>
                                            <span className="text-xl text-slate-600 dark:text-slate-400 font-medium">{m}</span>
                                        </li>
                                    ))
                                ) : (
                                    <li className="flex items-start gap-6">
                                        ...
                                        <span className="text-xl text-slate-600 dark:text-slate-400 font-medium">Providing high-quality education and character building.</span>
                                    </li>
                                )}
                            </ul>
                        </div>
            ...
            {/* Principal's Message */}
            <section className="container mx-auto px-4">
                <div className="relative group bg-white dark:bg-slate-950 rounded-[5rem] p-16 md:p-32 border border-slate-100 dark:border-slate-800 shadow-[0_40px_120px_rgba(0,0,0,0.05)] flex flex-col items-center text-center">
                    ...
                    <h2 className="text-5xl md:text-8xl font-black mb-12 tracking-tighter text-slate-900 dark:text-white">{t("profile.principalTitle")}</h2>
                    <p className="text-2xl md:text-[3.5rem] text-slate-600 dark:text-slate-400 leading-[1.2] italic max-w-5xl font-black tracking-tight">
            ...
            <section className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-end justify-between mb-24 gap-12">
                    <div className="flex-1">
                        ...
                        <h2 className="text-5xl md:text-[7rem] font-black tracking-tighter text-slate-900 dark:text-white leading-[0.9]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    {teachers.map((teacher) => (
                        <div key={teacher.id} className="group flex flex-col">
                            <div className="relative aspect-[3/4] rounded-[4.5rem] overflow-hidden mb-10 shadow-xl hover:shadow-[0_40px_100px_rgba(0,0,0,0.1)] transition-all duration-700 border border-slate-100 dark:border-slate-800">
                                <Image
                            ...
                            <h3 className="text-3xl font-black mb-3 group-hover:text-primary transition-colors text-slate-900 dark:text-white">{teacher.name}</h3>
                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mb-6">{teacher.position}</p>
                            <p className="text-slate-500 dark:text-slate-400 text-lg font-medium line-clamp-2 leading-relaxed">
                                {teacher.bio}
                            </p>
                        </div>
                    ))}
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
                        <div className="lg:col-span-5">
                            ...
                            <h2 className="text-6xl md:text-[6.5rem] font-black mb-12 tracking-tighter text-slate-900 dark:text-white leading-[0.9]">{t("profile.envHeadline")}</h2>
                            <p className="text-2xl text-slate-500 dark:text-slate-400 font-medium mb-20 leading-relaxed">
                                {t("profile.envSubheadline")}
                            </p>
                            <div className="space-y-12">
                                <div className="flex items-start gap-8 group">
                                    <div className="w-16 h-16 rounded-2xl bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 shadow-xl flex items-center justify-center shrink-0 group-hover:bg-primary transition-colors">
                                        <LucideIcons.MapPin className="h-8 w-8 text-primary group-hover:text-slate-900 dark:text-white transition-colors" />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-start gap-8 group">
                                    <div className="w-16 h-16 rounded-2xl bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 shadow-xl flex items-center justify-center shrink-0 group-hover:bg-primary transition-colors">
                                        <LucideIcons.PhoneCall className="h-8 w-8 text-primary group-hover:text-slate-900 dark:text-white transition-colors" />
                                    </div>
                                    <div>
                            ...
                            {facilities.length > 0 ? (
                                facilities.map((f, i) => (
                                    <div key={f.id} className={cn(
                                        ...
                                        <div className="absolute inset-0 bg-white dark:bg-slate-950/90 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-12 text-center backdrop-blur-md">
                                            <span className="text-slate-900 dark:text-white text-3xl font-black uppercase tracking-tighter">{f.name}</span>
                                        </div>
                                    </div>
                                ))
                            ) : (
